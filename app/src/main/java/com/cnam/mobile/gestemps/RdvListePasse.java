...
public class RdvListePasse extends AppCompatActivity implements RdvAdapter.RdvAdapterListener {
    ...
    public void onClickNom(final Rdv item, int position) {
        ...
        builder.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                Intent i = new Intent(RdvListePasse.this, RdvFiche.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rdv_liste_passe);
